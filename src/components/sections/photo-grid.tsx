        ...
        <FadeIn direction="up" className="flex flex-col justify-center">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            {siteConfig.galleryHighlights.slice(0, 2).map((item) => (
              ...
              >
                <p className="text-[11px] font-semibold tracking-[0.28em] text-primary/70 uppercase">
                  {item.tag}
                </p>
            ...
            >
              ...
              <div className="relative flex h-full flex-col justify-between">
                <div className="flex items-start justify-between gap-4">
                  <span className="rounded-full border border-white/20 bg-white/10 px-3 py-1 text-[10px] font-semibold tracking-[0.28em] uppercase text-white/90 backdrop-blur-sm">
                    {item.tag}
                  </span>
                ...
                <div>
                  <p className="text-xl font-semibold leading-tight md:text-2xl">{item.title}</p>
